  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black text-white">
      ...
      <header className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-5xl overflow-hidden">
        <div className="animate-fade-up border border-white rounded-lg title-page-main relative ">
        ...
        <div className="animate-fade-down flex flex-col laptop:flex-row justify-center items-center space-y-4 laptop:space-y-0 laptop:space-x-4">
          <a
            href="#"
