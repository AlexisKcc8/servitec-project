...
export const CardProduct = (props) => {
  ...
  return (
    <article className="w-[18rem] h-[35rem] text-center p-0 flex flex-col snap-center flex-shrink-0 rounded-lg border border-servitect-700 overflow-hidden">
      ...
      <section className="p-4 h-[40%] flex flex-col justify-between items-center">
        ...
        <h5 className="text-servitect-700 text-lg font-bold">${price}.00</h5>
        <p className="my-4 text-gray-700 overflow-hidden max-w-[15rem] text-ellipsis whitespace-pre-line line-clamp-2">
          {description}
        </p>
